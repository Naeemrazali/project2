...
def show_pcl(pcl):
    ...
    viz.create_window(self, window_name='Open3D', width=1920, height=1080, left=50, top=50, visible=True)
    ...
    viz.add_geometry(self, pcd, reset_bounding_box=True)
    
    # step 5 : visualize point cloud and keep window open until right-arrow is pressed (key-code 262)
    viz.register_key_callback(self, 262, o3d.visualization.draw_geometries([pcd]))
